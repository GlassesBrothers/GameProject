...
class LabState:
    def __init__(self, screen_width, screen_height, screen, inventory_equipped_item):
        ...
        self.lab_profile_image_path = os.path.join(self.script_directory, "../image/Lab/Lab_Prlfile.png")
        ...
        self.inventory_switch_path = os.path.join(self.script_directory, "../image/InventoryItems/Inventory_Switch.png")
        self.inventory_wire_path = os.path.join(self.script_directory, "../image/InventoryItems/Inventory_Wire.png")
        ...
        self.keykard_path = os.path.join(self.script_directory, "../image/Lab/Lab_KeyCard.png")
        self.keykard = pygame.image.load(self.keykard_path)
        
        
        # ... (다른 이미지들 로드 및 Rect 설정)
        
        self.lab_path = os.path.join(self.script_directory, "../image/Lab/Lab_background.png")
